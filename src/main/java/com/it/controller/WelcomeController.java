...
public class WelcomeController {
	...
	public ModelAndView course(@PathParam(value = "lang") String lan,@PathVariable String authorName) {
		System.out.println("Inside Cource method");
		ModelAndView mvn=new ModelAndView();
		String msgText=lan+" written by "+authorName ;
		System.out.println(lan+" "+authorName);
